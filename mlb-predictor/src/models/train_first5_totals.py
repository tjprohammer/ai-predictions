...
def main() -> int:
    ...
    feature_columns = [
        column for column in trainable.columns if column not in set(FIRST5_TOTALS_META_COLUMNS + [FIRST5_TOTALS_TARGET_COLUMN])
    ]
    category_columns = []
    ...
    report_path = save_report("first5_totals", artifact_name, artifact | {"model": None})
