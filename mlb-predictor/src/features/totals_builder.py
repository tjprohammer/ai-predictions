        ...
        rows.append(
            {
                ...
                "home_bullpen_late_innings_last3": home_bullpen["late_innings_last3"],
                "away_bullpen_late_innings_last3": away_bullpen["late_innings_last3"],
                "home_bullpen_late_runs_allowed_last3": home_bullpen["late_runs_allowed_last3"],
                "away_bullpen_late_runs_allowed_last3": away_bullpen["late_runs_allowed_last3"],
                "home_bullpen_late_earned_runs_last3": home_bullpen["late_earned_runs_last3"],
                "away_bullpen_late_earned_runs_last3": away_bullpen["late_earned_runs_last3"],
                "home_bullpen_late_hits_allowed_last3": home_bullpen["late_hits_allowed_last3"],
                "away_bullpen_late_hits_allowed_last3": away_bullpen["late_hits_allowed_last3"],
                "home_bullpen_late_era_last3": home_bullpen["late_era_last3"],
                "away_bullpen_late_era_last3": away_bullpen["late_era_last3"],
